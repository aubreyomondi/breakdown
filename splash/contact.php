...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/1jpg.jpg)">
			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">Nairobi, Kenya <br> Tellecom Towers</li>
							<li class="phone"><a href="tel://1234567920">+254 783 983 543</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">info@M-agriculture</a></li>
