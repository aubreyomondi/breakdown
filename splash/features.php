...
<html>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						<li class="active"><a href="features.php">About us</a></li>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/Farming.jpg)">
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1>M-agriculture <br> the face of the future</h1>		
						</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					...
					<p>Around half of Africa’s population have a mobile phone and this number is increasing. These mobile networks can be used to share essential information to remote communities where the effects of drought and crop disease can be devastating.

  In Ethiopia, where 85% of the population work in agriculture, this recognition has driven the development of a multi-lingual mobile-phone based resource centre. More than 3 million farmers have used the service created by the Ethiopian Agricultural Transformation Agency, and similar messaging resources operate in countries such as Tanzania, Ghana and Uganda.</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Connect farmers</h3>
						<p>You can always join our saccos and signup for symposiums in patnershp with M-agriculture </p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Irrigation program</h3>
						<p>This provides a getaway for farmers to explore the crops that do well on their soils.</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
				...
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Plan Ahead </h3>
						<p>Plan ahead of the seasons by followng our guidelines step by step.</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>M-Agriculture</h3>
						<p>This as an app that contains more about M-agriculture </p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Semminars & Symposiums</h3>
						<p>We host farmers for symposiums and seminars.</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
